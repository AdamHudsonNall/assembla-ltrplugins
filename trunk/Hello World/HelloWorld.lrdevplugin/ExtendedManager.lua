...
function ExtendedManager.initPrefs()
    ...
    app:initPref( 'background', true ) -- true to support on-going background processing, after async init (auto-update most-sel photo).
        ...
        elseif value ~= nil then
            app:call( Call:new{ name = 'Stop Background Task', async=true, guard=App.guardVocal, main=function( call )
                ...
                repeat
                    ...
                    if stopped then
                        app:logInfo( "Auto-check was stopped by user.", App.verbose )
