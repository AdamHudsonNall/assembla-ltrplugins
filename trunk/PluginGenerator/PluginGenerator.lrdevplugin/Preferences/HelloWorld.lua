...
--]]
_p.domainIdReversed = 'con.johndoe'
...
--]]
_p.projectDir = "X:\\Dev\\LightroomPlugins\\lrdevplugin\\trunk\\Hello World"
...
_p.devPluginName = str:fmt( "^1 (Dev)", _p.relPluginName )
...
--[[
        ...
        *** Note: this is NOT the toolkit ID.
--]]
...
--[[
        Lr Toolkit Identifier.
        
        Lightroom plugin ID. Developer edition must be distinguished from released edition if they are to coexist for testing.
        ( thus the '.lrdevplugin.' )
--]]
_p.devToolkitId = str:fmt( "^1.lrdevplugin.^2", _p.domainIdReversed, _p.pluginMash )
...
--]]
_p.pluginUrl = str:fmt( "http://^1/^2/ProductsAndServices/", "www.robcole.com", "Rob" )
...
--]]
_p.donateUrl = str:fmt( "http://^1/^2/Donate", "www.robcole.com", "Rob" )
...
--]]
_p.xmlRpcUrl = str:fmt( "http://^1/^2/_common/cfpages/XmlRpc.cfm", "www.robcole.com", "Rob" )
...
--[[
        ...
        *** Present "best practice" is to use objects for everything.
        ...
        take better advantage of object orient programming in the module,
        then its ready if its already a class.
--]]
_p.utils = true
...
--[[
        ...
        Set to true if you anticipate creating a class object and optionally derived class to be used in more than one plugin module.
        
        It is recommended to go ahead and include these if you are unsure, then delete if it turns out you won't need them.
--]]
_p.classes = true
...
--]]                
_p.metadata = false -- just so it doesn't bother people about the catalog when testing it out.
